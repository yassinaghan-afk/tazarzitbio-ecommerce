...
const GUIDES = [
  ...
  },
  {
    ...
    title: "منتجات مغربية للسيّاح",
    desc: "تقليدية 100٪ طبيعية — بدون سكر مضاف وبدون مواد حافظة، مع توصيل للفندق.",
  },
  {
    href: "/amlou/casablanca",
    title: "أملو حسب المدن",
    desc: "صفحات توصيل لكل المدن والوجهات السياحية: الدار البيضاء، مراكش، أكادير، تغازوت، الصويرة…",
  },
  {
