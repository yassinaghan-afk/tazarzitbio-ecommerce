  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            "relative shrink-0 overflow-hidden rounded-xl bg-gradient-to-br from-[#1a120c] to-[#2a1810] ring-1 ring-foreground/10",
        ...
        <div className="min-w-0 flex-1 space-y-2.5">
          <div>
            <h3
              className={cn(
                "font-extrabold leading-snug text-foreground",
          ...
          <Button
            ...
            className={cn(
              "w-full gap-1.5 rounded-full font-bold shadow-gold",
              compact && "h-9 text-xs",
            )}
            onClick={() =>
              addToCart(
