...
const arMessages = {
  ...
  "weightModal.kicker": "اختر الحجم",
  "weightModal.subtitle": "اختر الوزن المناسب — السعر يظهر مباشرة لكل خيار",
  "weightModal.selected": "اختيارك الحالي",
  "weightModal.continue": "متابعة الطلب",
  "weightModal.addToCart": "أضف للسلة",
  "weightModal.close": "إغلاق",
  "weightModal.cardHint": "اضغط اطلب الآن لاختيار الوزن",
  ...
  "footer.gifts": "منتجات طبيعية من قلب سوس →",
  "footer.about": "من نحن",
...
const fr: Record<TranslationKey, string> = {
  ...
  "weightModal.kicker": "Choisir la taille",
  "weightModal.subtitle": "Choisissez le poids — le prix s'affiche pour chaque option",
  "weightModal.selected": "Votre choix",
  "weightModal.continue": "Continuer la commande",
  "weightModal.addToCart": "Ajouter au panier",
  "weightModal.close": "Fermer",
  "weightModal.cardHint": "Appuyez sur Commander pour choisir le poids",
  ...
  "footer.gifts": "Produits naturels du Souss →",
...
const en: Record<TranslationKey, string> = {
  ...
  "weightModal.kicker": "Choose size",
  "weightModal.subtitle": "Pick a weight — each option shows its price",
  "weightModal.selected": "Your selection",
  "weightModal.continue": "Continue to order",
  "weightModal.addToCart": "Add to cart",
  "weightModal.close": "Close",
  "weightModal.cardHint": "Tap Order now to choose a weight",
  ...
  "footer.gifts": "Natural products from Souss →",
