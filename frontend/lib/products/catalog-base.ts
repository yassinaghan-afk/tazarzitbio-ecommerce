...
export function buildCatalog(overrides?: PricingOverrides): Product[] {
  ...
  const catalog: Product[] = [
    ...
    },
    {
      ...
      description:
        "أملو باللوز من تازارزيت بيو يُحضّر بطريقة تقليدية من لوز محلي مطحون وعسل طبيعي وزيت أركان بكر من سوس. قوام كريمي غني مناسب للفطور والضيافة، بدون مواد حافظة. متوفر بأحجام 250 غ و500 غ و750 غ مع توصيل لجميع مدن المغرب والدفع عند الاستلام.",
    ...
    },
    {
      ...
      description:
        "أملو بالفستق من تازارزيت بيو يجمع حبات الفستق الفاخرة مع عسل سوس وزيت أركان بكر. تحضير حرفي يحافظ على اللون الأخضر والنكهة الراقية، بدون مواد حافظة. مثالي لمن يبحث عن أملو فستق طبيعي للشراء أونلاين في المغرب مع الدفع عند الاستلام.",
    ...
    },
    {
      ...
      description:
        "زيت أركان تازارزيت بيو معصور على البارد من لوز الأركان المغربي الأصيل. غني بفيتامين E ومناسب للعناية اليومية بالبشرة والشعر والجسم. منتج طبيعي 100% من سوس، يمكن طلبه أونلاين مع توصيل لجميع المدن والدفع عند الاستلام.",
    ...
    },
    {
      ...
      description:
        "مكسرات بالعسل من تازارزيت بيو: لوز وجوز وفستق مختار يدوياً مع عسل طبيعي كثيف من سوس. بدون سكر مضاف — قرمشة وعسل ذهبي مثالي للضيافة والفطور. اطلب أونلاين مع توصيل لجميع مدن المغرب والدفع عند الاستلام.",
